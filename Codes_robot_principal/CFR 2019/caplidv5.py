...
def local(x,y,bal1,bal2,bal3,bal4):
    test = False
    balises_reelles = np.array([[60,1940,-220,1000],[-80,-80,1500,3020]])   #Positions exactes dans le repère
    rbal = 40
...
def main(x,y,cap):
    balises_reelles = np.array([[100,1900,-200,1000],[-30,-30,1500,3020]])   #Positions exactes dans le repère
    theta = cap + 0.52
