        ...
        while True:
            ...
            for c in contours:
                ...
                if (M["m00"] != 0 and M["m00"] != 0):
                    ...
                    cv2.putText(frame, "(" + str(cY) + "," + str(cX) + ")", (cX, cY + 5), font, 1, (255, 255, 0), 2,
                                cv2.LINE_AA)
...
class Robot(Thread):
    ...
    def commander_herse(self):
        self.ser_mega.write('h')       #demande d'envoie des couleurs
